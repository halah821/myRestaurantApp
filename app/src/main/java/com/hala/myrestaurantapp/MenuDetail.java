...
public class MenuDetail extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Menu detail API url
        MenuDetailAPI = com.hala.myrestaurantapp.Utils.MenuDetailAPI+"?accesskey="+ com.hala.myrestaurantapp.Utils.AccessKey+"&menu_id="+Menu_ID;
        ...
        btnShare.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				// go to share page
				Intent i = new Intent(MenuDetail.this, com.hala.myrestaurantapp.ShareMenu.class);
    ...
    public class getDataTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPostExecute(Void result) {
			...
			if((Menu_name != null) && IOConnect == 0){
				...
				imageLoader.DisplayImage(com.hala.myrestaurantapp.Utils.AdminPageURL+Menu_image,
						MenuDetail.this, imgPreview);
				
				txtText.setText(Menu_name);
				txtSubText.setText(Menu_price+" "+ com.hala.myrestaurantapp.MenuList.Currency+"\n"+"Serve for "+Menu_serve+" people");
    ...
    public void parseJSONData(){
    	...
    	try {
	       ...
	       /* HttpClient client = new DefaultHttpClient();
			...
			URL requestUrl=new URL(MenuDetailAPI);
