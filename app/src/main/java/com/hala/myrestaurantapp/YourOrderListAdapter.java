...
class YourOrderListAdapter extends BaseAdapter {
		...
		public int getCount() {
			...
			return com.hala.myrestaurantapp.YourOrder.Menu_ID.size();
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.txtMenuName.setText(com.hala.myrestaurantapp.YourOrder.Menu_name.get(position));
			holder.txtQuantity.setText(String.valueOf(com.hala.myrestaurantapp.YourOrder.Quantity.get(position)));
			holder.txtPrice.setText(com.hala.myrestaurantapp.YourOrder.Sub_total_price.get(position)+" "+ com.hala.myrestaurantapp.YourOrder.Currency);
