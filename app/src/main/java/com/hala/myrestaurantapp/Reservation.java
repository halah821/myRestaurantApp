...
public class Reservation extends FragmentActivity {
    ...
    // method to post data to server and return results
	public String getRequest(String name, String number_of_people, String date_n_time, String phone, String orderlist, String comment){
		String result = "";
			...
			params.put("number_of_people", number_of_people);
			params.put("date_n_time", date_n_time);
			...
			try
			{
				...
				URL url = new URL(Utils.SendDataAPI);
